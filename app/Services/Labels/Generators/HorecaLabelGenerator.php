...
class HorecaLabelGenerator extends AbstractLabelGenerator
{
    ...
    public function __construct(
        protected HorecaInformationRepository $repository
    ) {
        parent::__construct();
    }
    ...
    protected function generateLabelHtml($product): string
    {
        ...
        // HORECA: Always render barcode container with opacity 0 to maintain structure
        $barcodeHtml = "
                        <div class='barcode-section' style='opacity: 0;'>
                            <img src='data:image/png;base64,{$barcodeBase64}' class='barcode-image' />
                            <div class='barcode-number'>0000000000000</div>
                        </div>";
                ...
                <tr>
                    ...
                    <td class='left-column'>
                        ...
                        <div class='dates-section'>
                            ...
                            <p class='branch-line'><strong>SUCURSAL: {$branchName}</strong></p>
                        </div>
                    </td>
