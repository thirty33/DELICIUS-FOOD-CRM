...
class Order extends Model
{
    ...
    /**
     * Get shipping threshold information for next better shipping rate
     */
    protected function ShippingThresholdInfo(): Attribute
    {
        return Attribute::make(
            get: function () {
                $repository = new DispatchRuleRepository;

                return $repository->getShippingThresholdInfo($this);
            }
        );
    }
}
