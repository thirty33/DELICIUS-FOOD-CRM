...
class CategoriesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($categories as $categoryData) {
            ...
            // Crear menús y asociar categorías
            $menus = [];
            for ($day = 1; $day <= 31; $day++) {
                $menus[] = [
                    'title' => 'Menu ' . $day,
                    'description' => 'Description for Menu ' . $day,
                    'active' => true,
            ...
            foreach ($menus as $menuData) {
                $menu = Menu::firstOrCreate(['title' => $menuData['title']], $menuData);

                // Asociar categoría al menú
                CategoryMenu::firstOrCreate([
